...
{
    internal class NonDepositAccount : Account, IAccountConverter<NonDepositAccount>
    {
        public NonDepositAccount SetValue { get; set; }
        ...
        {
            id = Convert.ToString(Repository.AssignAccountId());
            accountNumber = AssignAccountNumber(id, OwnerOrgForm);
        }

        public NonDepositAccount() {}

        public string ConvertAccountToString(NonDepositAccount account)
        {
        ...
        public NonDepositAccount ConvertStringSplitedToAccount(string[] streamStringSplited)
        {
