...
{
    internal class DepositAccount : Account, IAccountConverter<DepositAccount>
    {
        ...
        public DepositAccount SetValue { get; set; }
        ...
        public string ConvertAccountToString(DepositAccount account)
        {
        ...
        public DepositAccount ConvertStringSplitedToAccount(string[] streamStringSplited)
        {
